...
def main():
    ...
    data_root = r"/kaggle/input/competitions/cse-281-spring-26-scene-style-classification/StyleClassificationIndoors/StyleClassificationIndoors/train"
    ...
    for epoch in range(num_epochs):
        ...
        if plateau_counter >= patience and unfreeze_index < len(layers_to_unfreeze):
            ...
            new_layer = layers_to_unfreeze[unfreeze_index]
